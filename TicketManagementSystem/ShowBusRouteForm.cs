...
{
    public partial class ShowBusRouteForm : Form
    {
        ...
        public ShowBusRouteForm(AdminDashboard adminDashboard)
        {
            InitializeComponent();
            this.adminDashboard = adminDashboard;
        }

        private void ShowBusRouteForm_Load(object sender, EventArgs e)
        {
            try
            {
                LoadLocationData();
        ...
        private void LoadLocationData()
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "SELECT * FROM BusLocation";
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "INSERT INTO BusLocation (LocationName) VALUES (@LocationName)";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "DELETE FROM BusLocation WHERE ID = @ID";
                    SqlCommand command = new SqlCommand(query, connection);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string query = "UPDATE BusLocation SET LocationName = @LocationName WHERE ID = @ID";
                    SqlCommand command = new SqlCommand(query, connection);
                    command.Parameters.AddWithValue("@LocationName", locationName);
                    command.Parameters.AddWithValue("@ID", locationId);
